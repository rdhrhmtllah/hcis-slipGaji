...
<body>
    <div class="success-card animate__animated animate__fadeIn shadow-lg">
        <div class="success-header">
            ...
            <h4 class="mb-0">Password Berhasil Diubah!</h4>
        </div>
        <div class="success-body">
            <p class="lead">Password Anda telah diperbarui dengan sukses.</p>

            <div class="spinner-whatsapp"></div>

            <p class="countdown">Anda akan diarahkan ke WhatsApp dalam <span id="countdown">5</span> detik...</p>

            <a href="https://wa.me/62879676" class="btn btn-whatsapp">
